...
$query_total_cursos = mysqli_query($conection, "SELECT cur.codigoRamo, cur.inicio, cur.codigoCurso, ROUND(AVG(eva.nota),2) as promedio, eva.usuario,
												...
												FROM cursos cur INNER JOIN evaluaciones eva WHERE isActive = true AND cur.codigoCurso = eva.codigoCurso AND eva.usuario = 'asagredo' GROUP BY cur.codigoCurso ORDER BY codigoRamo ASC");
