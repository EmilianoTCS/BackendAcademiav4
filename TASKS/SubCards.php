...
if (isset($_GET['usuario'])) {
    ...
    $query_total_cursos = mysqli_query($conection, "SELECT ram.nombreRamo, cur.inicio,cur.fin, cur.codigoCurso, ROUND(AVG(eva.nota),2) as promedio, eva.usuario,
												...
												FROM cursos cur INNER JOIN evaluaciones eva, ramos ram WHERE cur.codigoRamo = ram.codigoRamo AND cur.isActive = true AND cur.codigoCurso = eva.codigoCurso AND eva.usuario = '$usuario' GROUP BY cur.codigoCurso ORDER BY cur.codigoRamo ASC");
